...
{
    public class CreateContractCommandHandler(IIdGenerator<string> idGenerator, IContractRepository contractRepository,IVehicleRepository vehicleRepository, IPolicyRepository IPolicyRepository) : IApplicationService<CreateContractCommand, CreateContractResponse>
    {
        private readonly IIdGenerator<string> _idGenerator = idGenerator;
        private readonly IContractRepository _contractRepository = contractRepository;

        private readonly IVehicleRepository _vehicleRepository = vehicletRepository;

        private readonly IPolicyRepository _IPolicyRepository = IPolicyRepository;
